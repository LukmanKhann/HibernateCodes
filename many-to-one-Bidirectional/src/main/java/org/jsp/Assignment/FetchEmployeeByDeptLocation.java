...
public class FetchEmployeeByDeptLocation {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter Dept Location to display the emps details");
		...
		try {
			...
			System.err.println("Enter Dept location is invalid");
		}
	}
}
